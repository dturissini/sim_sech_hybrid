...
pdf_file <- paste('ssh_outlier_', outlier_type, '_sech_alleles_', win_size, '.pdf', sep='')
...
allele_table <- paste('outlier_', outlier_type, '_win_sechellia_alleles_', win_size, sep='')
allele_dist_table <- paste('outlier_', outlier_type, '_win_sech_adj_allele_dist_', win_size, sep='')
